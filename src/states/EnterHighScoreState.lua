--[[
    pantalla que nos permite ingresar un nuevo puntaje en forma de 3 caracteres,
    estilo arcade
]]
EnterHighScoreState = Class{__includes = BaseState}

--Caracteres individuales para nuestro string
local chars = {
    [1] = 65,
    [2] = 65,
    [3] = 65
...
--caracter que estamos cambiando actualmente
...
function EnterHighScoreState:update(dt)
    if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
        ...
        --Volver atras por los puntajes hasta este puntaje, cambiando los puntos
    ...
    -- pasar por los casilleros de los cararcteres
...
function EnterHighScoreState:render()
    ...
    --dibujar los caracteres del nombre
    ...
    love.graphics.printf('Enter para confirmar', 0, VIRTUAL_HEIGHT - 18, VIRTUAL_WIDTH, 'center')
end